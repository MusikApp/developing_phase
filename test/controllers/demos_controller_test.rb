...
class DemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demo" do
    assert_difference('Demo.count') do
      post demos_url, params: { demo: { active: @demo.active, content: @demo.content, user_id: @demo.user_id } }
    end
  ...
  test "should update demo" do
    patch demo_url(@demo), params: { demo: { active: @demo.active, content: @demo.content, user_id: @demo.user_id } }
