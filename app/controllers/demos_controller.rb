class DemosController < ApplicationController
  ...
  def create
    @demo = Demo.new(content: params[:content], video: params[:video], user_id: current_user.id)

    respond_to do |format|
      if @demo.save
        format.html { redirect_to root_path, notice: "Demo was successfully created." }
  ...
  private
    ...
    def demo_params
      params.require(:demo).permit(:content, :active, :user_id)
    end
end
